            ...
            <div className="p-4 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-x-20 max-w-[1200px]">
                    ...
                    <div className="space-y-[2px]">
                        ...
                        <ClassicInput label="Remark" disabled />
                        <ClassicInput label="Employee Name" isYellow />

                    </div>

                    {/* Right Column */}
                    <div className="space-y-[2px]">
                        <ClassicInput label="Doc Num" isYellow />
                        <ClassicInput label="Employee ID" disabled />
                        <ClassicInput label="No of Children" />
                    </div>
                </div>
                            ...
                            <table className="w-full border-collapse text-[11px]">
                                <thead>
                                    <tr className="bg-[#e0e0e0] border-b border-slate-400 text-slate-700">
                                        ...
                                        <th className="border-r border-slate-400 py-0.5 px-1 font-semibold text-left">Contact No</th>
                                    </tr>
                                </thead>
                                <tbody>

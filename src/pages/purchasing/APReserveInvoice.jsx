      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-end gap-10">
          ...
          <div className="w-[300px] space-y-[2px]">
            ...
            <div className="flex items-center gap-1 mb-[2px]">
              <span className="text-[11px] text-slate-800 w-[140px] shrink-0 font-medium">Total Down Payment</span>
              <div className="flex-1 flex gap-1 items-center">
                <button className="w-5 h-[18px] bg-yellow-400 border border-slate-400 flex items-center justify-center gap-[1px]">
...
export default function APReserveInvoice() {
  ...
  useEffect(() => {
    ...
    openWindow({
      id: 'ap-reserve-invoice',
      title: 'A/P Reserve Invoice',
      component: <APReserveInvoiceContent />,
...
export { APReserveInvoiceContent };

        ...
        <div className="flex justify-between items-start gap-4">
          ...
          <div className="w-[30%] space-y-[1px]">
            <div className="flex items-center gap-1 mb-[2px]">
              ...
              <div className="flex-1 flex gap-1 items-center">
                <ClassicSel options={['DHAB-GRN']} className="w-20" />
                 ...
                 <table className="w-full text-[10px] border-collapse min-w-[1700px]">
                   <thead>
                     <tr className="bg-slate-100 border-b border-slate-400 sticky top-0 z-10">
                       ...
                       <th className="border-r border-slate-400 px-2 py-1 text-left min-w-[100px]">BP Catalog No.</th>
                       <th className="border-r border-slate-400 px-2 py-1 text-left min-w-[150px]">Item Description</th>
                       ...
                       <th className="px-2 py-1 text-left min-w-[150px]">Standard Item Identification</th>
                     </tr>
                   </thead>
                   <tbody>
...
export default function GoodsReceiptPO() {
  ...
  useEffect(() => {
    ...
    openWindow({
      ...
      component: <GoodsReceiptPOContent />,

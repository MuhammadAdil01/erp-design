        ...
        <div className="flex justify-between items-start gap-4">
          ...
          <div className="w-[30%] space-y-[1px]">
            <div className="flex items-center gap-1 mb-[2px]">
              ...
              <div className="flex-1 flex gap-1 items-center">
                <ClassicSel options={['DHAB-OB']} className="w-20" />
                <ClassicInput value="1408" className="w-16 bg-slate-100" />
              </div>
            </div>
            ...
            <FieldRow label="IPC No" labelWidth="120px">
              <ClassicInput value={form.ipcNo} onChange={handleChange('ipcNo')} />
            </FieldRow>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-[400px]">
          ...
          {activeTab === 'Logistics' && (
            <div className="flex gap-20">
              ...
              <div className="w-[400px] space-y-4 pt-[156px]">
                <FieldRow label="Stamp No." labelWidth="120px">
                   <ClassicInput value={form.stampNo} onChange={handleChange('stampNo')} />
                </FieldRow>
              </div>
            </div>
          )}
          ...
          {activeTab === 'Accounting' && (
            <div className="flex gap-20">
               <div className="w-[400px] space-y-[2px]">
                  ...
                  <FieldRow label="Control Account" labelWidth="140px">
                    <ClassicInput value={form.controlAccount} onChange={handleChange('controlAccount')} />
                  </FieldRow>
                  <div className="flex items-center gap-2 py-1">
                    <input type="checkbox" checked={form.paymentBlock} onChange={handleChange('paymentBlock')} />
                    <span className="text-[11px] text-slate-800 w-[122px] shrink-0">Payment Block</span>
                    <ClassicInput value={form.paymentBlockReason} onChange={handleChange('paymentBlockReason')} className="flex-1 bg-white" />
                  </div>
                  <div className="flex items-center gap-2">
                    <input type="checkbox" checked={form.maxCashDiscount} onChange={handleChange('maxCashDiscount')} />
                    <span className="text-[11px] text-slate-800">Max. Cash Discount</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 py-1">
                    ...
                    <ClassicInput value={form.installments} onChange={handleChange('installments')} className="w-6 text-center bg-transparent border-none font-bold" disabled />
                  </div>
                  <div className="flex items-center gap-2 py-1">
                  ...
                  <div className="pt-2"></div>
                  <div className="flex items-center gap-2">
                    <input type="checkbox" checked={form.deferredTax} onChange={handleChange('deferredTax')} />
                    <span className="text-[11px] text-slate-800">Deferred Tax</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <input type="checkbox" checked={form.netProcedure} onChange={handleChange('netProcedure')} />
                    <span className="text-[11px] text-slate-800">Net Procedure</span>
                  </div>
               ...
               <div className="flex-1 max-w-[400px] space-y-[2px]">
                  ...
                  <div className="pt-2"></div>
                  <FieldRow label="Asset Value Date" labelWidth="140px">
                    <ClassicInput value={form.assetValueDate} onChange={handleChange('assetValueDate')} />
                  </FieldRow>
               </div>
            </div>
          )}
          ...
          <div className="w-[300px] space-y-[2px]">
            ...
            <div className="flex items-center gap-2">
               ...
               <div className="flex gap-1 flex-1">
                 <ClassicInput className="w-12 text-right" disabled />
                 <span className="text-[11px] self-center">%</span>
                 <ClassicInput className="bg-slate-100 flex-1" disabled />
               </div>
            </div>
            <div className="flex items-center gap-1 mb-[2px]">
            ...
            <div className="flex items-center gap-2 py-[2px]">
              <input type="checkbox" checked={form.rounding} onChange={handleChange('rounding')} />
              <span className="text-[11px] text-slate-800 w-[122px] shrink-0">Rounding</span>
              <ClassicInput disabled className="bg-slate-100 flex-1" />
            </div>

      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-start gap-4">
          ...
          <div className="w-[30%] space-y-[1px]">
            <div className="flex items-center gap-1 mb-[2px]">
              ...
              <div className="flex-1 flex gap-1 items-center">
                <ClassicSel options={['DHAB-APC']} className="w-20" />
        ...
        <div className="flex justify-between items-end gap-10">
          ...
          <div className="w-[300px] space-y-[2px]">
            ...
            <FieldRow label="Open Balance" labelWidth="140px">
              <ClassicInput disabled className="bg-slate-100" />
            </FieldRow>
          </div>
        </div>
...
export default function APCreditMemo() {

...
const PurchaseQuotationContent = () => {
  ...
  const tabs = ['Contents', 'Logistics', 'Accounting', 'Attachments', 'Initial Statement', 'Comments'];
        ...
        <div className="flex justify-between items-start gap-4">
          ...
          <div className="w-[30%] space-y-[1px]">
            ...
            <div className="flex items-center gap-1">
              <span className="text-[11px] text-slate-800 w-[100px] shrink-0 font-medium">Group No.</span>
              <div className="flex-1 flex gap-1 items-center">
                <ClassicSel options={['DHAB-PQ']} className="w-20" />
                <ClassicInput value={form.groupNo} onChange={handleChange('groupNo')} className="w-16" />
                <div className="w-4 h-4 border border-slate-400 rounded-full flex items-center justify-center text-[10px] text-slate-500 bg-white">i</div>
              </div>
            </div>
          </div>
          ...
          {/* Middle Header */}
          <div className="w-[30%] space-y-[1px]">
            <FieldRow label="Project Director Approval" labelWidth="160px">
              <ClassicSel options={['Unapproved', 'Approved']} />
            </FieldRow>
            <FieldRow label="Secretary Approval" labelWidth="160px">
              <ClassicSel options={['Unapproved', 'Approved']} />
            </FieldRow>
            <FieldRow label="Procurement Director Approval" labelWidth="160px">
              <ClassicSel options={['Unapproved', 'Approved']} />
            </FieldRow>
            <FieldRow label="Routed to" labelWidth="160px">
              <ClassicInput />
            </FieldRow>
          </div>
          ...
          <div className="w-[30%] space-y-[1px]">
            <div className="flex items-center gap-1 mb-[2px]">
              ...
              <div className="flex-1 flex gap-1">
                <ClassicSel options={['DHAB-PQ']} className="w-1/2" />
                <ClassicInput value="632" className="w-1/2 bg-slate-100" />
              </div>
            </div>
                 ...
                 <table className="w-full text-[10px] border-collapse min-w-[1800px]">
                   <thead>
                     <tr className="bg-slate-100 border-b border-slate-400 sticky top-0 z-10">
                       ...
                       <th className="border-r border-slate-400 px-2 py-1 text-left min-w-[100px]">Quoted Qty.</th>
                       ...
                       <th className="border-r border-slate-400 px-2 py-1 text-left min-w-[100px]">Quoted Date</th>
          ...
          {activeTab === 'Logistics' && (
            <div className="flex gap-20">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="flex-1 flex flex-col gap-1">
                    ...
                    <div className="flex justify-end -mt-6 mr-1">
                       <button className="w-6 h-4 bg-yellow-400 text-white flex items-center justify-center text-[10px]">...</button>
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="space-y-2 pt-4">
                <div className="flex items-center gap-2">
                  <input type="checkbox" checked={form.createOnline} onChange={handleChange('createOnline')} />
                  <span className="text-[11px] text-slate-800">Create Online Quotation</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          {activeTab === 'Comments' && (
            <div className="space-y-[1px] max-w-[500px]">
              {Array.from({ length: 10 }).map((_, i) => (
                <FieldRow key={i} label={`PQ - ${i + 1}`} labelWidth="60px">
                  <ClassicInput />
                </FieldRow>
              ))}
            </div>
          ...
          <div className="w-[300px] space-y-[1px]">
            ...
            <div className="flex items-center gap-2">
               ...
               <div className="flex gap-1 flex-1">
                 <ClassicInput className="w-12 text-right" value="0.00" />
...
export default function PurchaseQuotation() {
  ...
  useEffect(() => {
    ...
    openWindow({
      ...
      component: <PurchaseQuotationContent />,
      initialSize: { width: 1200, height: 850 },
      initialPosition: { x: 40, y: 10 },
    });
...
export { PurchaseQuotationContent };

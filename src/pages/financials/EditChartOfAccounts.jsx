...
const SelectField = ({ label, options, className = "" }) => (
    <div className={cn("space-y-1.5 flex-1 min-w-[240px]", className)}>
        <label className="text-[10px] font-bold text-yellow-700 uppercase tracking-widest block">{label}</label>
        <select className="w-full bg-white border border-yellow-200 rounded-xl px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-yellow-400/30 focus:border-yellow-400 transition-all appearance-none cursor-pointer font-semibold text-slate-700">
            {options.map((opt, i) => (
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex gap-3">
                        <button className="px-6 py-2.5 rounded-xl border border-yellow-200 text-yellow-700 hover:bg-yellow-50 transition-all font-bold shadow-sm bg-white">
                            Cancel Changes
                        </button>
                        <button
                            className="px-8 py-2.5 rounded-xl text-white hover:opacity-90 transition-all font-bold shadow-lg flex items-center gap-2"
                    ...
                    <div className="p-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                              ...
                              <button
                                className="px-8 py-2.5 mt-5 rounded-xl text-white font-bold shadow-lg flex items-center gap-2 hover:opacity-90 transition-all"
                                style={{ background: 'linear-gradient(135deg, #f59e0b, #d97706)' }}
                            >
                                <Save size={18} /> Save Fields
                            </button>
                    </div>
                </div>
